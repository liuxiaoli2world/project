...
var _jsxFileName = "E:\\documents\\git\\project\\hello-next\\pages\\index.jsx";
...
var Index = function Index(props) {
  ...
  }, "Bataman TV Shows"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("ul", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    }
  ...
  return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          data = _context.sent;
          console.log("count ".concat(data.length));
